...
# this guy is used by OfferFetcherThread
class CityAddressResolverStub():
    @staticmethod
    def resolve(*sources):
        return u"Kraków, Polska"

# this guy is used by OfferFetcherThread
class UrlFetcherStub():
    @staticmethod
...
class Test(unittest.TestCase):
    ...
    def setUp(self):
        InjectDependency.setDependency('urlfetcher', UrlFetcherStub)
    ...
    def testFetchOffer(self):
        ...
        t = OfferFetcherThread(inQueue, outQueue, CityAddressResolverStub)
        t.start() 
        ...
        ACTUAL_ADDRESS =  u"Kraków, Polska"       
        self.assertEquals(ACTUAL_ADDRESS, offer["address"])
        
        ACTUAL_LONGLATT = [50, 10]
        self.assertEquals(ACTUAL_LONGLATT, offer["longlatt"])
