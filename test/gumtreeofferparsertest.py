...
# -*- coding: utf-8 -*-
import unittest
from gumtreeofferparser import (extractPrice, extractDate, extractTitle,
    extractAddress, extractDescription, extractSummary, extractImageUrl)
...
class Test(unittest.TestCase):
    ...
    def testExtractDescription(self):
        ...
        description = extractDescription(OFFER_HTML)
        self.assertEquals(ACTUAL_DESCRIPTION, description)
        
    def testExtractSummary(self):
        ...
        summary = extractSummary(OFFER_HTML)
    ...
    def testExtractImageUrl(self):
        ...
        url = extractImageUrl(OFFER_HTML)
