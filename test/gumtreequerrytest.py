...
class Test(unittest.TestCase):
    ...
    def testAllParamsSupplied(self):
        EXPECTED_QUERRY = 'http://www.gumtree.pl/fp-mieszkania-i-domy-do-wynajecia/Krakow/Nowa+Huta/c9008l3200208?A_AreaInMeters_max=70&A_AreaInMeters_min=30&A_ForRentBy=ownr&A_NumberRooms=10&AdType=2&isSearchForm=true&maxPrice=1000&maxPriceBackend=200000&minPrice=500&minPriceBackend=100000'
        querry = GumtreeQuerry.compose(city="Krakow", 
                                       ...
                                       minArea="30",
                                       maxArea="70")
        self.assertEquals(EXPECTED_QUERRY, querry)
